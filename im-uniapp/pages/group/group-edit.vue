	...
	<view class="page group-edit">
		...
		<view class="form">
			<view class="form-item">
				...
				<image-upload v-if="isOwner||isManager" :isPermanent="true" :onSuccess="onUnloadImageSuccess">
			...
			<view class="form-item">
				...
				<input class="input" :class="isOwner||isManager?'':'disable'" maxlength="20" v-model="group.name"
					:disabled="!isOwner&&!isManager" placeholder="请输入群聊名称" />
			</view>
			<view class="form-item">
			...
			<view class="form-item">
				...
				<textarea class="notice" :class="isOwner||isManager?'':'disable'" maxlength="512"
					:disabled="!isOwner&&!isManager" v-model="group.notice"
					:placeholder="isOwner||isManager?'请输入群公告':''"></textarea>
			</view>
		</view>
